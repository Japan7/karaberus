...
func addRoutes(api huma.API) {
	...
	huma.Get(api, "/api/user/{id}", GetUserEndpoint, setSecurity(oidc_security))
	huma.Get(api, "/api/me", GetMeEndpoint, setSecurity(oidc_security))
	huma.Put(api, "/api/user/{id}/author", UpdateUserAuthorEndpoint, setSecurity(oidc_security))
	huma.Put(api, "/api/me/author", UpdateMeAuthorEndpoint, setSecurity(oidc_security))
}
